...
#ifndef BDE_VERSION_H
#define BDE_VERSION_H

#ifdef __cplusplus
extern \"C\" {
#endif

/** @defgroup bde_version_defs Definitions */
/** @defgroup bde_version_papi Public API */

/* Includes ----------------------------------------------------------------------------------------------------------*/
/* Exported types ----------------------------------------------------------------------------------------------------*/
/**
 * @addtogroup bde_version_defs
 * @{
 */
...
set(PROJECT_VERSION_FILE_LOCATION "${PROJECT_ROOT_DIR}/src/inc/bde/other/version.h")
...
configure_file("${PROJECT_VERSION_FILE_LOCATION}" "${PROJECT_VERSION_FILE_LOCATION}" NEWLINE_STYLE CRLF)
